...
add_fileset_file avalon_pwm.vhd VHDL PATH MySOPC/avalon_pwm.vhd TOP_LEVEL_FILE
...
add_interface_port conduit_end_1 out_pwm writeresponsevalid_n Output 1

...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../MySOPC.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1090
SOPC_SYSID_FLAG += --sidp=0x1090
ELF_PATCH_FLAG  += --sidp 0x1090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1732177774
SOPC_SYSID_FLAG += --timestamp=1732177774
ELF_PATCH_FLAG  += --timestamp 1732177774
